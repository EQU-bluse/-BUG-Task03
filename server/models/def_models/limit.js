    ...
    var t_quota = sequelize.define('t_quota', {
        ...
        },
        {
            associate: function (models) {
                t_quota.belongsTo(models.t_cst_base_info, {as: "base", foreignKey: "company_id", targetKey: 'id', constraints: false});
                t_quota.belongsTo(models.t_cst_vice_info, {as: "vice", foreignKey: "company_id", targetKey: 'id', constraints: false});
            }
        });
    return t_quota;
}