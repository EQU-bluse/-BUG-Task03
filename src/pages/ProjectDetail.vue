...
<script type="text/ecmascript-6">
    ...
    export default {
      ...
      created(){
        this.act_flag=this.$route.params.flag;
        Promise.all([api.GetChannelStatus(),api.GetProjectStatus()])
        .then(res=>{
        ...
        if(this.act_flag=='edit'){
          api.GetProject(this.$route.query)
          .then(res => {
